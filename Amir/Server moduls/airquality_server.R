airquality_server <- function(input, output){
  ...
  observe ({
    ...
    #ville2="Paris"
        #result=mydata$find(query = paste0('{"city.city": { $eq: Paris }}'))
        #print(result$city)
    
    ts <- mydata$find('{}', fields='{"hourly_units_european_aqi":true ,"hourly_units_pm10":true, "hourly_units_pm2_5":true, "hourly_units_carbon_monoxide":true ,"hourly_units_nitrogen_dioxide":true, "hourly_units_sulphur_dioxide":true, "hourly_units_ozone":true,"_id" : false}', limit=1)
