...
IDF <- mongo(collection = "IDF", db = "linuxproject")
...
Lyon <- mongo(collection = "Lyon", db = "linuxproject")
...
Lille <- mongo(collection = "Lille", db = "linuxproject")
...
Toulouse <- mongo(collection = "Toulouse", db = "linuxproject")
